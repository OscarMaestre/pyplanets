#!/usr/bin/env python
# coding=latin1
#Este programa crea una peque�a animaci�n del Sistema Solar a escala real
...
while 1:
    ...
    if teclas[pygame.K_UP]:    
        centro_y=centro_y+incr_y
        offset_y_sol=offset_y_sol+incr_y
    if teclas[pygame.K_DOWN]:
        centro_y=centro_y-incr_y
        offset_y_sol=offset_y_sol-incr_y
    if teclas[pygame.K_RIGHT]:
        centro_x=centro_x+incr_x
        offset_x_sol=offset_x_sol+incr_x
    if teclas[pygame.K_LEFT]:
        centro_x=centro_x-incr_x
        offset_x_sol=offset_x_sol-incr_x
    if teclas[pygame.K_PLUS] and escala<25:
        escala=escala+incr_escala
    if teclas[pygame.K_MINUS] and escala>1:
        escala=escala-incr_escala


    rect_sol.centerx=centro_x
    rect_sol.centery=centro_y
